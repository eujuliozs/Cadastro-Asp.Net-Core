...
namespace CADASTRO_.Controllers
{
    public class PessoasController : Controller
    {
        private readonly CADASTRO_Context _context;

        public PessoasController(CADASTRO_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pessoa != null ? 
                          ...
                          Problem("Entity set 'CADASTRO_Context.Pessoa'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CADASTRO_Context.Pessoa'  is null.");
            }
            var pessoa = await _context.Pessoa.FindAsync(id);
            if (pessoa != null)
            {
